module Spree
  module ApplicationControllerDecorator
    ...
    def set_current_tenant
      # Use the current_store helper that Spree provides
      # This handles store selection based on domain/subdomain
...
Spree::ApplicationController.prepend Spree::ApplicationControllerDecorator if defined?(Spree::ApplicationController)